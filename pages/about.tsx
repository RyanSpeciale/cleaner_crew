...
const message: string = 'The Cleaner Crew is pleased to provide families with customized cleanings organized specifically for each home. We offer a variety of different types of cleanings to target the type of service to best suit the client. In the services tabs, each cleaning is broken down to explain what services are included in each cleaning; please remember, all cleanings are customizable- you name it, WE CLEAN IT!'
